...
const Header = () => {
    ...
    return (
        <nav className='flex justify-between items-center pt-6'>
            ...
            <ul className={`md:flex items-center gap-12 space-y-3 md:space-y-0 md:static absolute bg-white rounded-lg md:rounded-none md:bg-transparent p-3 md:p-0 right-2 duration-500 ${isMenuActive ? "top-28" : "-top-96"} z-10`}>
